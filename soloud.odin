...
foreign lib {
    ...
    // Soloud
    @(link_name="Soloud_destroy") destroy :: proc(soloud: Soloud) ---
    @(link_name="Soloud_create") create :: proc() -> Soloud ---
    @(link_name="Soloud_init") init :: proc(soloud: Soloud) -> i32 ---
    @(link_name="Soloud_initEx") init_ex :: proc(soloud: Soloud, flags: u32, backend: u32, sample_rate: u32, buffersize: u32, channels: u32) -> i32 ---
    @(link_name="Soloud_deinit") deinit :: proc(soloud: Soloud) ---
    @(link_name="Soloud_getVersion") get_version :: proc(soloud: Soloud) -> u32 ---
    @(link_name="Soloud_getErrorString") get_error_string :: proc(soloud: Soloud, errorCode: i32) -> cstring ---
    @(link_name="Soloud_getBackendId") get_backend_id :: proc(soloud: Soloud) -> u32 ---
    @(link_name="Soloud_getBackendString") get_backend_string :: proc(soloud: Soloud) -> cstring ---
    @(link_name="Soloud_getBackendChannels") get_backend_channels :: proc(soloud: Soloud) -> u32 ---
    @(link_name="Soloud_getBackendSamplerate") get_backend_samplerate :: proc(soloud: Soloud) -> u32 ---
    @(link_name="Soloud_getBackendBufferSize") get_backend_buffer_size :: proc(soloud: Soloud) -> u32 ---
    @(link_name="Soloud_setSpeakerPosition") set_speaker_position :: proc(soloud: Soloud, channel: u32, x: f32, y: f32, z: f32) -> i32 ---
    @(link_name="Soloud_getSpeakerPosition") get_speaker_position :: proc(soloud: Soloud, channel: u32, x: ^f32, y: ^f32, z: ^f32) -> i32 ---
    @(link_name="Soloud_play") play :: proc(soloud: Soloud, sound: Audio_Source) -> u32 ---
    @(link_name="Soloud_playEx") play_ex :: proc(soloud: Soloud, sound: Audio_Source, volume: f32 /* = -1.0f */, pan: f32 /* = 0.0f */, paused: i32 /* = 0 */, bus: u32 /* = 0 */) -> u32 ---
    @(link_name="Soloud_playClocked") play_clocked :: proc(soloud: Soloud, sound_time: f64, sound: Audio_Source) -> u32 ---
    @(link_name="Soloud_playClockedEx") play_clocked_ex :: proc(soloud: Soloud, sound_time: f64, sound: Audio_Source, volume: f32 /* = -1.0f */, pan: f32 /* = 0.0f */, bus: u32 /* = 0 */) -> u32 ---
    @(link_name="Soloud_play3d") play_3d :: proc(soloud: Soloud, sound: Audio_Source, x: f32, y: f32, z: f32) -> u32 ---
    @(link_name="Soloud_play3dEx") play_3d_ex :: proc(soloud: Soloud, sound: Audio_Source, x: f32, y: f32, z: f32, vel_x: f32 /* = 0.0f */, vel_y: f32 /* = 0.0f */, vel_z: f32 /* = 0.0f */, volume: f32 /* = 1.0f */, paused: i32 /* = 0 */, bus: u32 /* = 0 */) -> u32 ---
    @(link_name="Soloud_play3dClocked") play_3d_clocked :: proc(soloud: Soloud, sound_time: f64, sound: Audio_Source, x: f32, y: f32, z: f32) -> u32 ---
    @(link_name="Soloud_play3dClockedEx") play_3d_clocked_ex :: proc(soloud: Soloud, sound_time: f64, sound: Audio_Source, x: f32, y: f32, z: f32, vel_x: f32 /* = 0.0f */, vel_y: f32 /* = 0.0f */, vel_z: f32 /* = 0.0f */, volume: f32 /* = 1.0f */, bus: u32 /* = 0 */) -> u32 ---
    @(link_name="Soloud_playBackground") play_background :: proc(soloud: Soloud, sound: Audio_Source) -> u32 ---
    @(link_name="Soloud_playBackgroundEx") play_background_ex :: proc(soloud: Soloud, sound: Audio_Source, volume: f32 /* = -1.0f */, paused: i32 /* = 0 */, bus: u32 /* = 0 */) -> u32 ---
    @(link_name="Soloud_seek") seek :: proc(soloud: Soloud, voice_handle: u32, seconds: f64) -> i32 ---
    @(link_name="Soloud_stop") stop :: proc(soloud: Soloud, voice_handle: u32) ---
    @(link_name="Soloud_stopAll") stop_all :: proc(soloud: Soloud) ---
    @(link_name="Soloud_stopAudioSource") stop_audio_source :: proc(soloud: Soloud, sound: Audio_Source) ---
    @(link_name="Soloud_countAudioSource") count_audio_source :: proc(soloud: Soloud, sound: Audio_Source) -> i32 ---
    @(link_name="Soloud_setFilterParameter") set_filter_parameter :: proc(soloud: Soloud, voice_handle: u32, filter_id: u32, attribute_id: u32, value: f32) ---
    @(link_name="Soloud_getFilterParameter") get_filter_parameter :: proc(soloud: Soloud, voice_handle: u32, filter_id: u32, attribute_id: u32) -> f32 ---
    @(link_name="Soloud_fadeFilterParameter") fade_filter_parameter :: proc(soloud: Soloud, voice_handle: u32, filter_id: u32, attribute_id: u32, to: f32, time: f64) ---
    @(link_name="Soloud_oscillateFilterParameter") oscillate_filter_parameter :: proc(soloud: Soloud, voice_handle: u32, filter_id: u32, attribute_id: u32, from: f32, to: f32, time: f64) ---
    @(link_name="Soloud_getStreamTime") get_stream_time :: proc(soloud: Soloud, voice_handle: u32) -> f64 ---
    @(link_name="Soloud_getStreamPosition") get_stream_position :: proc(soloud: Soloud, voice_handle: u32) -> f64 ---
    @(link_name="Soloud_getPause") get_pause :: proc(soloud: Soloud, voice_handle: u32) -> i32 ---
    @(link_name="Soloud_getVolume") get_volume :: proc(soloud: Soloud, voice_handle: u32) -> f32 ---
    @(link_name="Soloud_getOverallVolume") get_overall_volume :: proc(soloud: Soloud, voice_handle: u32) -> f32 ---
    @(link_name="Soloud_getPan") get_pan :: proc(soloud: Soloud, voice_handle: u32) -> f32 ---
    @(link_name="Soloud_getSamplerate") get_samplerate :: proc(soloud: Soloud, voice_handle: u32) -> f32 ---
    @(link_name="Soloud_getProtectVoice") protect_voice :: proc(soloud: Soloud, voice_handle: u32) -> i32 ---
    @(link_name="Soloud_getActiveVoiceCount") get_active_voice_count :: proc(soloud: Soloud) -> u32 ---
    @(link_name="Soloud_getVoiceCount") get_voice_count :: proc(soloud: Soloud) -> u32 ---
    @(link_name="Soloud_isValidVoiceHandle") is_valid_voice_handle :: proc(soloud: Soloud, voice_handle: u32) -> i32 ---
    @(link_name="Soloud_getRelativePlaySpeed") get_relative_play_speed :: proc(soloud: Soloud, voice_handle: u32) -> f32 ---
    @(link_name="Soloud_getPostClipScaler") get_post_clip_scaler :: proc(soloud: Soloud) -> f32 ---
    @(link_name="Soloud_getGlobalVolume") get_global_volume :: proc(soloud: Soloud) -> f32 ---
    @(link_name="Soloud_getMaxActiveVoiceCount") get_max_active_voice_count :: proc(soloud: Soloud) -> u32 ---
    @(link_name="Soloud_getLooping") get_looping :: proc(soloud: Soloud, voice_handle: u32) -> i32 ---
    @(link_name="Soloud_getLoopPoint") get_loop_point :: proc(soloud: Soloud, voice_handle: u32) -> f64---
    @(link_name="Soloud_setLoopPoint") set_loop_point :: proc(soloud: Soloud, voice_handle: u32, loop_point: f64) ---
    @(link_name="Soloud_setLooping") set_looping :: proc(soloud: Soloud, voice_handle: u32, looping: i32) ---
    @(link_name="Soloud_setMaxActiveVoiceCount") set_max_active_voice_count :: proc(soloud: Soloud, voice_count: i32) -> i32 ---
    @(link_name="Soloud_setInaudibleBehavior") set_inaudible_behavior :: proc(soloud: Soloud, voice_handle: u32, must_tick: i32, kill: i32) ---
    @(link_name="Soloud_setGlobalVolume") set_global_volume :: proc(soloud: Soloud, volume: f32) ---
    @(link_name="Soloud_setPostClipScaler") set_post_clip_scaler :: proc(soloud: Soloud, scale: f32) ---
    @(link_name="Soloud_setPause") set_pause :: proc(soloud: Soloud, voice_handle: u32, pause: i32) ---
    @(link_name="Soloud_setPauseAll") pause_all :: proc(soloud: Soloud, pause: i32) ---
    @(link_name="Soloud_setRelativePlaySpeed") set_relative_play_speed :: proc(soloud: Soloud, voice_handle: u32, speed: f32) -> i32 ---
    @(link_name="Soloud_setProtectVoice") set_protect_voice :: proc(soloud: Soloud, voice_handle: u32, protect: i32) ---
    @(link_name="Soloud_setSamplerate") set_samplerate :: proc(soloud: Soloud, voice_handle: u32, samplerate: f32) ---
    @(link_name="Soloud_setPan") set_pan :: proc(soloud: Soloud, voice_handle: u32, pan: f32) ---
    @(link_name="Soloud_setPanAbsolute") set_pan_absolute :: proc(soloud: Soloud, voice_handle: u32, l_volume: f32, r_volume: f32) ---
    @(link_name="Soloud_setPanAbsoluteEx") set_pan_absolute_ex :: proc(soloud: Soloud, voice_handle: u32, l_volume: f32, r_volume: f32, b_volume: f32 /* = 0 */, rb_volume: f32 /* = 0 */, c_volume: f32 /* = 0 */, s_volume: f32 /* = 0 */) ---
    @(link_name="Soloud_setVolume") set_volume :: proc(soloud: Soloud, voice_handle: u32, volume: f32) ---
    @(link_name="Soloud_setDelaySamples") set_delay_samples :: proc(soloud: Soloud, voice_handle: u32, samples: i32) ---
    @(link_name="Soloud_fadeVolume") fade_volume :: proc(soloud: Soloud, voice_handle: u32, to: f32, time: f64) ---
    @(link_name="Soloud_fadePan") fade_pan :: proc(soloud: Soloud, voice_handle: u32, to: f32, time: f64) ---
    @(link_name="Soloud_fadeRelativePlaySpeed") fade_relative_play_speed :: proc(soloud: Soloud, voice_handle: u32, to: f32, time: f64) ---
    @(link_name="Soloud_fadeGlobalVolume") fade_global_volume :: proc(soloud: Soloud, to: f32, time: f64) ---
    @(link_name="Soloud_schedulePause") schedule_pause :: proc(soloud: Soloud, voice_handle: u32, time: f64) ---
    @(link_name="Soloud_scheduleStop") schedule_stop :: proc(soloud: Soloud, voice_handle: u32, time: f64) ---
    @(link_name="Soloud_oscillateVolume") oscillate_volume :: proc(soloud: Soloud, voice_handle: u32, from: f32, to: f32, time: f64) ---
    @(link_name="Soloud_oscillatePan") oscillate_pan :: proc(soloud: Soloud, voice_handle: u32, from: f32, to: f32, time: f64) ---
    @(link_name="Soloud_oscillateRelativePlaySpeed") oscillate_relative_play_speed :: proc(soloud: Soloud, voice_handle: u32, from: f32, to: f32, time: f64) ---
    @(link_name="Soloud_oscillateGlobalVolume") oscillate_global_volume :: proc(soloud: Soloud, from: f32, to: f32, time: f64) ---
    @(link_name="Soloud_setGlobalFilter") set_global_filter :: proc(soloud: Soloud, filter_id: u32, filter: Filter) ---
    @(link_name="Soloud_setVisualizationEnable") set_visualization_enable :: proc(soloud: Soloud, enable: i32) ---
    @(link_name="Soloud_calcFFT") calc_fft :: proc(soloud: Soloud) -> f32 ---
    @(link_name="Soloud_getWave") get_wave :: proc(soloud: Soloud) -> f32 ---
    @(link_name="Soloud_getApproximateVolume") get_approximate_volume :: proc(soloud: Soloud, channel: i32) -> f32 ---
    @(link_name="Soloud_getLoopCount") get_loop_count :: proc(soloud: Soloud, voice_handle: u32) -> u32 ---
    @(link_name="Soloud_getInfo") get_info :: proc(soloud: Soloud, voice_handle: u32, info_key: u32) -> f32 ---
    @(link_name="Soloud_createVoiceGroup") create_voice_group :: proc(soloud: Soloud) -> u32 ---
    @(link_name="Soloud_destroyVoiceGroup") destroy_voice_group :: proc(soloud: Soloud, voice_group_handle: u32) -> i32 ---
    @(link_name="Soloud_addVoiceToGroup") add_voice_to_group :: proc(soloud: Soloud, voice_group_handle: u32, voice_handle: u32) -> i32 ---
    @(link_name="Soloud_isVoiceGroup") is_voice_group :: proc(soloud: Soloud, voice_group_handle: u32) -> i32 ---
    @(link_name="Soloud_isVoiceGroupEmpty") is_voice_group_empty :: proc(soloud: Soloud, voice_group_handle: u32) -> i32 ---
    @(link_name="Soloud_update3dAudio") update_3d_audio :: proc(soloud: Soloud) ---
    @(link_name="Soloud_set3dSoundSpeed") set_3d_sound_speed :: proc(soloud: Soloud, speed: f32) -> i32 ---
    @(link_name="Soloud_get3dSoundSpeed") get_3d_sound_speed :: proc(soloud: Soloud) -> f32 ---
    @(link_name="Soloud_set3dListenerParameters") set_3d_listener_parameters :: proc(soloud: Soloud, x: f32, y: f32, z: f32, at_x: f32, at_y: f32, at_z: f32, up_x: f32, up_y: f32, up_z: f32) ---
    @(link_name="Soloud_set3dListenerParametersEx") set_3d_listener_parameters_ex :: proc(soloud: Soloud, x: f32, y: f32, z: f32, at_x: f32, at_y: f32, at_z: f32, up_x: f32, up_y: f32, up_z: f32, vel_x: f32 /* = 0.0f */, vel_y: f32 /* = 0.0f */, vel_z: f32 /* = 0.0f */) ---
    @(link_name="Soloud_set3dListenerPosition") set_3d_listener_position :: proc(soloud: Soloud, x: f32, y: f32, z: f32) ---
    @(link_name="Soloud_set3dListenerAt") set_3d_listener_at :: proc(soloud: Soloud, at_x: f32, at_y: f32, at_z: f32) ---
    @(link_name="Soloud_set3dListenerUp") set_3d_listener_up :: proc(soloud: Soloud, up_x: f32, up_y: f32, up_z: f32) ---
    @(link_name="Soloud_set3dListenerVelocity") set_3d_listener_velocity :: proc(soloud: Soloud, vel_x: f32, vel_y: f32, vel_z: f32) ---
    @(link_name="Soloud_set3dSourceParameters") set_3d_source_parameters :: proc(soloud: Soloud, voice_handle: u32, x: f32, y: f32, z: f32) ---
    @(link_name="Soloud_set3dSourceParametersEx") set_3d_source_parameters_ex :: proc(soloud: Soloud, voice_handle: u32, x: f32, y: f32, z: f32, vel_x: f32 /* = 0.0f */, vel_y: f32 /* = 0.0f */, vel_z: f32 /* = 0.0f */) ---
    @(link_name="Soloud_set3dSourcePosition") set_3d_source_position :: proc(soloud: Soloud, voice_handle: u32, x: f32, y: f32, z: f32) ---
    @(link_name="Soloud_set3dSourceVelocity") set_3d_source_velocity :: proc(soloud: Soloud, voice_handle: u32, vel_x: f32, vel_y: f32, vel_z: f32) ---
    @(link_name="Soloud_set3dSourceMinMaxDistance") set_3d_source_min_max_distance :: proc(soloud: Soloud, voice_handle: u32, min_dist: f32, max_dist: f32) ---
    @(link_name="Soloud_set3dSourceAttenuation") set_3d_source_attenuation :: proc(soloud: Soloud, voice_handle: u32, attenuation_model: u32, attenuation_rolloff_factor: f32) ---
    @(link_name="Soloud_set3dSourceDopplerFactor") set_3d_source_doppler_factor :: proc(soloud: Soloud, voice_handle: u32, doppler_factor: f32) ---
    @(link_name="Soloud_mix") mix :: proc(soloud: Soloud, buffer: ^f32, samples: i32) ---
    @(link_name="Soloud_mixSigned16") mix_signed_16 :: proc(soloud: Soloud, buffer: ^i16, samples: i32) ---
